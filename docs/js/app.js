 ...
 */
    ...
    (() => {
        ...
        function tabs() {
            ...
            const puzzleClose = document.querySelectorAll(".puzzle-close");
            let tabsActiveHash = [];
            if (tabs.length > 0) {
                const hash = getHash();
                ...
                puzzleClose.forEach(((tabsClose, index) => {
                    tabsClose.classList.add("_tab-init");
                    tabsClose.setAttribute("data-tabs-index", index);
                    tabsClose.addEventListener("click", setTabsAction);
                    initTabs(tabsClose);
                }));
